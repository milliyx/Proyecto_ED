//Genera la ultima tabla (penultimo paso del metodo)
class tablaImplicantes{
    ...
    createView(elemName, minterms){
        ...
        html+='<th>Representación binaria</th>'+'</tr>'+'</thead>';
...
//Genera la simplicacion dependiendo su agrupacion
class simplificacionTabla{
    constructor(simpl){
        this.minterminosAgrup = simpl;
    }

    //Muestra la tabla de simplificaciones
    createView(elemName){
        let html = '<table class="table is-bordered">'+
                '<thead>'+
                    '<tr>'+
